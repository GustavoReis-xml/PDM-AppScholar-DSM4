...
import ListaCursos from '../screens/ListaCursos';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login" screenOptions={defaultScreenOptions}>
        ...
        <Stack.Screen name="CadastroCursos" component={CadastroCursos} options={{ title: 'Novo Curso' }} />
        ...
        <Stack.Screen name="ListaCursos" component={ListaCursos} options={{ title: 'Cursos' }} />
